    ...
    return (
      <div className="min-h-screen bg-primary-black text-white">
        ...
        <main className="container mx-auto p-6 max-w-3xl">
          <h1 className="text-5xl font-title text-primary-yellow mb-6">About Beri Tracker</h1>
  
          {/* Description */}
          <section className="mb-8">
            <h2 className="text-3xl font-blackops text-secondary-blue mb-4">What is Beri Tracker?</h2>
            <p className="text-lg font-nunito">
              <strong>Beri Tracker</strong> is a fun and practical finance tracker inspired by the world of{" "}
